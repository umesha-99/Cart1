...
<div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-sm bg-primary-admin navbar-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="abc">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                        <a class="nav-link active" href="#"><b>Add Products</b></a>
                        </li>
                        <li class="nav-item">
    ...
    <div id="addItem">
        <form action="#" method="POST">
          ...
          <input type="textarea" id="productDiscription" name="productDiscription" ><br>

          <label for="productPrice">Product Price:</label><br>
          <input type="text" id="productPrice" name="productPrice" ><br>

          <label for="productImgURL">Product Image URL:</label><br>
          <input type="textbox" id="productImgURL" name="productImgURL" ><br>
